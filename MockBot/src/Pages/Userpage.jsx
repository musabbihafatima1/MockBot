...
const Dashboard = () => {
  ...
  const testData = {
    iq: { score: 92, percentile: 87, completed: true },
    technical: { score: 88, percentile: 91, completed: true },
    eq: { score: 85, percentile: 78, completed: true }
  };
  ...
  const barChartData = {
    labels: Object.keys(testData).map(test => 
      test.charAt(0).toUpperCase() + test.slice(1)
    ),
    datasets: [{
      data: Object.values(testData).map(test => test.score),
      backgroundColor: [
        '#5D009F', // Only first bar purple
        '#3f37c9', // Original colors for others
        '#f72585'
      ],
      borderWidth: 0,
      borderRadius: 6,
  ...
  const colors = {
    primary: '#4361ee', // Original primary color
    accent: '#5D009F',  // Purple accent color
  ...
  const styles = {
    ...
    sidebarItem: {
      ...
      '&:hover': {
        color: colors.accent // Only hover color changed to purple
      }
    },
    sidebarIcon: {
      marginRight: '12px',
    ...
    profileIcon: {
      ...
      height: '40px',
      borderRadius: '50%',
      backgroundColor: colors.accent, // Changed to purple
      color: '#ffffff',
      display: 'flex',
      alignItems: 'center',
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.mainContent}>
          ...
          <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <div>
              <h1 style={{ 
                ...
                margin: 0,
                color: colors.accent // Changed to purple
              }}>
                Candidate Dashboard
              </h1>
              <p style={{ 
        ...
        {/* Score Cards - Only changed the first card's accent color */}
          ...
          <div style={styles.progressContainer}>
            ...
            <div style={styles.progressCircle}>
              <CircularProgressbar
                ...
                styles={buildStyles({
                  pathColor: colors.accent, // Changed to purple
