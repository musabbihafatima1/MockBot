...
const EQPage = () => {
  ...
  const content = {
    ...
    steps: [
      {
        number: 1,
        title: "33 MCQs and 35 minutes",
        description: "The EQ test consists of 33 carefully designed multiple-choice questions which need to be done within 35 minutes.",
      },
      {
        number: 2,
        title: "Auto-Submission on Tab Switch",
        description: "To ensure test integrity, switching browser tabs during the test will automatically submit your responses.",
      },
      {
        number: 3,
        title: "Emotional Intelligence Evaluation",
        description: "Your results will reveal your emotional intelligence level based on response accuracy and psychological profiling models.",
      },
      {
        number: 4,
        title: "One Attempt Every 6 Months",
        description: "This EQ test can only be attempted once every 6 months to reflect genuine emotional growth and development.",
      },
    ],
  ...
  useEffect(() => {
    const checkAttemptStatus = async () => {
      try {
        ...
        const response = await axios.get("http://localhost:5000/api/auth/canAttemptEQ", {
        ...
        // Client-side validation to prevent timezone issues
